...
// 業務回報里程 modal
window.openReportKmModal = (sysKm) => {
  ...
  modal.innerHTML = `
    <div style="background:#fff;border-radius:16px 16px 0 0;width:100%;padding:24px;max-height:80vh;overflow-y:auto">
      <div style="font-size:16px;font-weight:600;margin-bottom:4px">回報今日里程</div>
      <div style="font-size:13px;color:#999;margin-bottom:16px">系統計算：${sysKm} km</div>
